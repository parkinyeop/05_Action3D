...
public class Test_Battle :  Test_Base
{
    ...
    protected override void Test4(InputAction.CallbackContext _)
    {
        ...
        GameObject[] objs8 = ItemFactory.MakeItem(ItemIdCode.Sheild01,1, new Vector3(1, 0, 2f), true);
        GameObject[] objs9 = ItemFactory.MakeItem(ItemIdCode.Sheild02,1, new Vector3(1, 0, 2f), true);
