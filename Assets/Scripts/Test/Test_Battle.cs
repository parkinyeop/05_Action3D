...
public class Test_Battle :  Test_Base
{
    ...
    protected override void Test4(InputAction.CallbackContext _)
    {
        ...
        GameObject[] objs6 = ItemFactory.MakeItem(ItemIdCode.IronSword,1, new Vector3(5, 0, 0f), true);
        GameObject[] objs7 = ItemFactory.MakeItem(ItemIdCode.SilverSword,1, new Vector3(5, 0, 5f), true);
        GameObject[] objs8 = ItemFactory.MakeItem(ItemIdCode.RoundSheild,1, new Vector3(0, 0, 0f), true);
        GameObject[] objs9 = ItemFactory.MakeItem(ItemIdCode.IronSheild,1, new Vector3(5, 0, 5f), true);
